...
const TRANSLATIONS_EN = {
  ...
  updates: {
    ...
    currentVersion: "VersiÃ³n instalada",
    latestVersion: "Ãšltima release",
    releaseLabel: "Release",
    checkedAt: "Ãšltima comprobaciÃ³n",
    publishedAt: "Publicada",
    checkNow: "Buscar actualizaciones",
    openRelease: "Abrir Ãºltima release",
    openReleaseFailed: "No se pudo abrir la pÃ¡gina de releases de GitHub",
    bannerMessage: "Hay una nueva versiÃ³n disponible: v{latest} (instalada v{current})",
    statusUnknown: "TodavÃ­a no se ha comprobado si hay updates",
    statusChecking: "Comprobando actualizaciones...",
    statusAvailable: "Update disponible: v{version}",
    statusUpToDate: "Esta app estÃ¡ actualizada",
    statusError: "No se pudo consultar la Ãºltima release",
    errorLabel: "Ãšltimo error"
  },
  updates: {
    sectionTitle: "Application Updates",
    currentVersion: "Installed version",
...
const TRANSLATIONS_ES = {
  ...
  updates: {
    sectionTitle: "Actualizaciones de la aplicacion",
    currentVersion: "Version instalada",
    latestVersion: "Ultima release",
    releaseLabel: "Release",
    checkedAt: "Ultima comprobacion",
    publishedAt: "Publicada",
    checkNow: "Buscar actualizaciones",
    openRelease: "Abrir ultima release",
    openReleaseFailed: "No se pudo abrir la pagina de releases de GitHub",
    bannerMessage: "Hay una nueva version disponible: v{latest} (instalada v{current})",
    statusUnknown: "Todavia no se ha comprobado si hay updates",
    statusChecking: "Comprobando actualizaciones...",
    statusAvailable: "Update disponible: v{version}",
    statusUpToDate: "Esta app esta actualizada",
    statusError: "No se pudo consultar la ultima release",
  ...
  updates: {
    ...
    dismissTitle: "Descartar aviso de update",
    dismissPrompt: "Quieres ocultar la notificacion para {version}?",
    dismissOnce: "Ocultar por ahora",
    dismissOnceDescription: "Oculta el banner hasta que reinicies la app o se detecte una release mas nueva.",
    dismissVersion: "No recordarmelo mas",
    dismissVersionDescription: "No volvera a mostrarse el banner para {version}. Si sale una release mas nueva, se avisara otra vez.",
    dismissedSessionToast: "Aviso de update oculto en esta sesion",
    dismissedVersionToast: "No se volvera a recordar {version}",
    reminderMutedLabel: "Recordatorio desactivado",
    reminderMutedMessage: "El banner para {version} esta oculto hasta que se publique una release mas nueva.",
    enableReminder: "Volver a mostrar aviso",
    reminderRestoredToast: "Recordatorio de update reactivado",
